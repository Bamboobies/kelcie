...
const BACKGROUND_SPEED = -10 // Slow background speed
...
function preload() {
  ...
  this.load.image('background', 'https://i.ibb.co/2XWRWxZ/1739319234354.jpg') // Background image
}
...
function create() {
  ...
  // Title text with dynamic scaling
